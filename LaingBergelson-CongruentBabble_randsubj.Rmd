...
# Links with later development

```{r Shapiro tests devdata}

shapiro.test(subset(devdata, audio_video == "audio")$nTokens) # not normal
shapiro.test(subset(devdata, audio_video == "audio")$nTypes) # not normal
shapiro.test(subset(devdata, audio_video == "video")$nTokens) # not normal
shapiro.test(subset(devdata, audio_video == "video")$nTypes) # not normal
shapiro.test(subset(devdata, audio_video == "video")$nTypes) # not normal
shapiro.test(subset(devdata, month == "18")$CDI_TotalProd) # not normal

```

```{r Correlations with later development}

# CDI at 12m
cor.test(subset(devdata, month == 12)$CDI_TotalProd, subset(devdata, month == 12)$audiotokens, method = "spearman") # ns
cor.test(subset(devdata, month == 12)$CDI_TotalProd, subset(devdata, month == 12)$audiotypes, method = "spearman") # ns
cor.test(subset(devdata, month == 12)$CDI_TotalProd, subset(devdata, month == 12)$CPtypes, method = "spearman") # ns
cor.test(subset(devdata, month == 12)$CDI_TotalProd, subset(devdata, month == 12)$CPtokens, method = "spearman") # ns

# CDI at 15m
cor.test(subset(devdata, month == 15)$CDI_TotalProd, subset(devdata, month == 15)$audiotokens, method = "spearman") # ns
cor.test(subset(devdata, month == 15)$CDI_TotalProd, subset(devdata, month == 15)$audiotypes, method = "spearman") # ns
cor.test(subset(devdata, month == 15)$CDI_TotalProd, subset(devdata, month == 15)$CPtypes, method = "spearman") # ns
cor.test(subset(devdata, month == 15)$CDI_TotalProd, subset(devdata, month == 15)$CPtokens, method = "spearman") # ns

# CDI at 18m
cor.test(subset(devdata, month == 18)$CDI_TotalProd, subset(devdata, month == 18)$audiotokens, method = "spearman") # ns
cor.test(subset(devdata, month == 18)$CDI_TotalProd, subset(devdata, month == 18)$audiotypes, method = "spearman") # ns
cor.test(subset(devdata, month == 18)$CDI_TotalProd, subset(devdata, month == 18)$CPtypes, method = "spearman") # ns
cor.test(subset(devdata, month == 18)$CDI_TotalProd, subset(devdata, month == 18)$CPtokens, method = "spearman") # ns

# Word tokens produced at 12m

cor.test(subset(devdata, month == 12 & audio_video == "audio")$nTypes, 
         subset(devdata, month == 12 & audio_video == "audio")$audiotokens, method = "spearman") # p=.052

cor.test(subset(devdata, month == 12 & audio_video == "audio")$nTokens, 
         subset(devdata, month == 12 & audio_video == "audio")$audiotypes, method = "spearman") # ns

cor.test(subset(devdata, month == 12 & audio_video == "video")$nTypes, 
         subset(devdata, month == 12 & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 12 & audio_video == "video")$nTokens, 
         subset(devdata, month == 12 & audio_video == "video")$CPtokens, method = "spearman") # ns

# Word tokens produced at 15m

cor.test(subset(devdata, month == 15 & audio_video == "audio")$nTypes, 
         subset(devdata, month == 15 & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == 15 & audio_video == "audio")$nTokens, 
         subset(devdata, month == 15 & audio_video == "audio")$audiotypes, method = "spearman") # ns

cor.test(subset(devdata, month == 15 & audio_video == "video")$nTypes, 
         subset(devdata, month == 15 & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 15 & audio_video == "video")$nTokens, 
         subset(devdata, month == 15 & audio_video == "video")$CPtokens, method = "spearman") # ns

# Word tokens produced at 17m

cor.test(subset(devdata, month == 17 & audio_video == "audio")$nTypes, 
         subset(devdata, month == 17 & audio_video == "audio")$audiotokens, method = "spearman") # p=.052

cor.test(subset(devdata, month == 17 & audio_video == "audio")$nTokens, 
         subset(devdata, month == 17 & audio_video == "audio")$audiotypes, method = "spearman") # ns

cor.test(subset(devdata, month == 17 & audio_video == "video")$nTypes, 
         subset(devdata, month == 17 & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 17 & audio_video == "video")$nTokens, 
         subset(devdata, month == 17 & audio_video == "video")$CPtokens, method = "spearman") # p=.01

# Input at 6, 12, 17m

cor.test(subset(devdata, month == "06" & audio_video == "audio")$nInput, 
         subset(devdata, month == "06" & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == "06" & audio_video == "video")$nInput, 
         subset(devdata, month == "06" & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 12 & audio_video == "audio")$nInput, 
         subset(devdata, month == 12 & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == 12 & audio_video == "video")$nInput, 
         subset(devdata, month == 12 & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 17 & audio_video == "audio")$nInput, 
         subset(devdata, month == 17 & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == 17 & audio_video == "video")$nInput, 
         subset(devdata, month == 17 & audio_video == "video")$CPtypes, method = "spearman") # ns

# Input at 10 and 11m

cor.test(subset(devdata, month == 10 & audio_video == "audio")$nInput, 
         subset(devdata, month == 10 & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == 10 & audio_video == "video")$nInput, 
         subset(devdata, month == 10 & audio_video == "video")$CPtypes, method = "spearman") # ns

cor.test(subset(devdata, month == 11 & audio_video == "audio")$nInput, 
         subset(devdata, month == 11 & audio_video == "audio")$audiotokens, method = "spearman") # ns

cor.test(subset(devdata, month == 11 & audio_video == "video")$nInput, 
         subset(devdata, month == 11 & audio_video == "video")$CPtypes, method = "spearman") # ns

```

```{r Predictors of later language ~ VMS}

# VMS as a predictor of later language

wilcox.test(CDI_TotalProd ~ VMSgroup, data = subset(devdata, month == 18))  # p= .09
wilcox.test(CDI_TotalProd ~ VMSgroup, data = subset(devdata, month == 15))  # ns
wilcox.test(CDI_TotalProd ~ VMSgroup, data = subset(devdata, month == 12))  # ns

wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 12 & audio_video == "audio"))  # ns
wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 15 & audio_video == "audio"))  # ns
wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 17 & audio_video == "audio"))  # p=.055

wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 12 & audio_video == "audio"))  # ns
wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 15 & audio_video == "audio"))  # p<.05
wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 17 & audio_video == "audio"))  # ns

wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 12 & audio_video == "video"))  # ns
wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 15 & audio_video == "video"))  # p<.05
wilcox.test(nTypes ~ VMSgroup, data = subset(devdata, month == 17 & audio_video == "video"))  # p=.05

wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 12 & audio_video == "video"))  # ns
wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 15 & audio_video == "video"))  # p=.01
wilcox.test(nTokens ~ VMSgroup, data = subset(devdata, month == 17 & audio_video == "video"))  # ns

# Input as a predictor of VMS

wilcox.test(nInput ~ VMSgroup, data = subset(devdata, month == "06" & audio_video == "video"))  # ns
wilcox.test(nInput ~ VMSgroup, data = subset(devdata, month == "06" & audio_video == "audio"))  # ns


```

```{r Age at first word ~ VMS}

shapiro.test(subset(devdata, month == 12 & audio_video == "audio")$Age1stWordaudio) # not normal
shapiro.test(subset(devdata, month == 12 & audio_video == "audio")$Age1stWordvideo) # normal (just)
shapiro.test(subset(devdata, month == 12 & audio_video == "audio")$Age1stWordCDI) # not normal

wilcox.test(Age1stWordaudio ~ VMSgroup, subset(devdata, month == 12 & audio_video == "audio"))  # p<.01
wilcox.test(Age1stWordvideo ~ VMSgroup, subset(devdata, month == 12 & audio_video == "audio"))  # p<.01
wilcox.test(Age1stWordCDI ~ VMSgroup, subset(devdata, month == 12 & audio_video == "audio"))  # ns
